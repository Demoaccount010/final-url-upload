...
from database import consume_quota, get_usage, check_expiry_and_update, add_file_record, remove_file_record
import os
from database import consume_quota, get_usage
...
async def echo(bot, update):
    ...
    try:
        ...
        # if DB not available, allow by default to avoid breaking bot
        allowed = True
    if not allowed:
        await bot.send_message(
            ...
            text=(
                ...
                "Aapka free daily limit khatam ho gaya hai. Premium ke liye /buy"
            ),
