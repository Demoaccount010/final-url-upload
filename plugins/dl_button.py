...
async def ddl_call_back(bot, update):
    ...
    if not allowed:
        await bot.edit_message_text(
            text=(
                ...
                "Aapka free daily limit khatam ho gaya. Premium ke liye /buy."
            ),
    ...
    try:
        await add_file_record(update.message.chat.id, os.path.basename(download_directory))
    except Exception:
        pass
